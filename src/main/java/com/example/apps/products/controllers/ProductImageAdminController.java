...
public class ProductImageAdminController {
    ...
    public ResponseEntity<ApiTemplate<Void, ProductImageDTO>> create(
        ...
        return ResponseEntity.ok(
                ApiTemplate.apiTemplateGenerator(true, 200, servletRequest.getRequestURI(), null, createdProductImage));
    }
    ...
    public ResponseEntity<ApiTemplate<Void, ProductImageDTO>> update(@PathVariable Long id,
        ...
        return ResponseEntity.ok(
                ApiTemplate.apiTemplateGenerator(true, 200, servletRequest.getRequestURI(), null, updatedProductImage));
    }
